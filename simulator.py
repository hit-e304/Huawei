...
class CROSS(object):
    def __init__(self, id_, north_, east_, south_, west_):
        ...
        self.providerDirection, self.receiverDirection, self.validRoadDirection = [], [], []
        for index, roadId in enumerate(self.roadIds):
            ...
            if road is not None:
                self.validRoadDirection.append(index)
        ...
        self.validRoad = [self.roadIds[direction] for direction in self.validRoadDirection]
